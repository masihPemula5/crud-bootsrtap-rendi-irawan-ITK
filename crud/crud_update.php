...
$profile_picture = isset($_SESSION['profile_pict']) ? $_SESSION['profile_pict'] : 'default-avatar.png';
...
$query = "SELECT profile_pict FROM users WHERE id_user = ?";
...
$profile_picture = $row['profile_pict'] ?? 'default-avatar.png';
...
<a href='hapus.php?id_mhs=" . $row['id_mhs'] . "' onclick='return konfir(event, this)' class='btn btn-sm btn-danger'><i class='fas fa-trash'></i> Hapus</a>
  ...
  echo '<div class="nodata-img d-flex justify-content-center"><img  src="../style/nodata.jpg" width="300px" height="300px alt=""></div>';
  $username = $_SESSION['username'];
}
...
$username = $_SESSION['username'];
$profile_picture = $_SESSION['profile_pict'];
?>
<script>
...
<body>
  ...
  <img id="avatar" class="avatar" src="<?php echo htmlspecialchars($profile_picture); ?>" alt="Profile Picture">
  ...
  <div id="uploadModal"
    ...
    <div style="position: relative; margin: auto; padding: 20px; background: #fff; width: 300px; text-align: center;">
      <h3>Upload Foto Avatar</h3>
      <form action="upload_avatar.php" method="post" enctype="multipart/form-data">
        <!-- Hidden field untuk mengirim id_user -->
        <input type="hidden" name="id_user" value="<?php echo $_SESSION['id_user']; ?>"> <!-- Diisi otomatis -->
